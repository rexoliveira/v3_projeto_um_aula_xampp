  ...
  <body class="body">
    <section class="sidebar">
      ...
      <section class="logo_details">
        <img
          class="icon"
          src="../image/icon/smart-city-200.png"
          alt="imagem_lateral"
        />
      ...
      <ul class="nav_list">
        ...
        <li>
          ...
          <span class="tooltip menu">Usuário</span>
        </li>
        ...
        <li class="profile">
          <section class="profile_details">
            <img
              class="img_user"
              src="../image/icon/profile_user.jpg"
        ...
        <section id="all_cards">
          <section class="cards_ver">
            ...
            <section class="card_hor vertical">
              <a href="#">
                ...
                <img
                  class="image_card"
                  src="https://media2.giphy.com/media/gjrOAylhpZm3dLnO5J/200w.gif"
                  alt="meteorologia"
                />
              </a>
            </section>
            ...
            <section class="card_hor vertical">
              <a href="#" target="_blank">
                ...
                <img
                  class="image_card"
                  src="../image/icon/meteorologia.png"
                  alt="meteorologia"
                />
              </a>
            </section>
          ...
          <section class="cards_hor">
            <section class="card_hor tempo">
              <a
                href="https://weather.com/weather/today/l/-30.85,-51.81?par=google"
                target="_blank"
              >
                <h1 class="title_card_hor">Tempo</h1>
                <img
                  class="image_card tempo"
            ...
            <section class="card_hor cultura">
              <a
                href="https://www.camaqua.rs.gov.br/portal/noticias/0/3/5489/secretaria-da-cultura-disponibilizara-links-de-atualizacao-de-cadastros-culturais"
                target="_blank"
              >
                <h1 class="title_card_hor">Cultura</h1>
                <img
                  class="image_card cultura"
            ...
            <section class="card_hor transito">
              <a
                href="https://www.google.com/maps/@-30.8542051,-51.8078113,16.13z/data=!5m1!1e1"
                target="_blank"
              >
                <h1 class="title_card_hor">Transito</h1>
              </a>
              <iframe
                class="image_card transito"
            ...
            <section class="card_hor noticia">
              <a
                href="https://www.cliccamaqua.com.br/noticias/"
                target="_blank"
              >
                <h1 class="title_card_hor">Noticias</h1>
                <img
                  class="image_card noticias"
                  src="../image/icon/click_camaqua.png"
                  alt="cultura"
                />
              </a>
            </section>
            ...
            <section class="card_hor camara">
              <a href="https://www.camaracq.rs.gov.br/" target="_blank">
                <h1 class="title_card_hor">Câmara</h1></a
              >
              <iframe
                class="image_card_camara"
