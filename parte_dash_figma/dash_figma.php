...
<body>
    ...
    <section class="container">
        ...
        <header>
            ...
            <ul class="exo-menu">
                <li>
                    <a class="active" href="#" onclick="genioFullScreen()" id="btn"><i class="fa fa-arrows-alt"></i>
                        Tela-grande</a>
                </li>
                <li class="drop-down">
                ...
                <li class="blog-drop-down">
                    ...
                    <div class="Blog animated fadeIn">
                        <div class="col-md-4">
                            ...
                            <div class="blog-des">
                                <h4 class="blog-titulo">Cidades Inteligentes: o que são e suas vantagens<br>Fonte:<a
                                        class="https://blog-online.pucrs.br/public/cidades-inteligentes-conceito-e-vantagens/"
                                        target="_blank" href="#"> PUCRS online</a>
                                </h4>
                                <p class="blog-texto">
                                    As cidades inteligentes ou smart cities, são centros que conseguem alinhar os
                                    avanços tecnológicos com o progresso social e ambiental, através das tecnologias
                                    digitais e disruptivas. O objetivo dessas urbanizações é proporcionar aos cidadãos
                                    uma melhor qualidade de vida.

                                    Assim, as cidades consideradas inteligentes são as que fazem uso estratégico de
                                    infraestrutura, serviços, informação e comunicação com o planejamento e gestão
                                    urbana necessários, dando resposta às necessidades sociais e econômicas da
                                    sociedade.

                                    Nesse sentido, o cidadão e os serviços essenciais estão conectados, utilizam energia
                                    limpa, reaproveitam a água, tratam o lixo, compartilham produtos, serviços e
                                    espaços, além de se deslocar com facilidade e usufruir de serviços públicos de
                                    qualidade.
                                </p>
                                <a class="texto_base_blog"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="blog-des">
                                ...
                                <a class="texto_base_blog" href="#">Consulte mais informação</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <img class="img-responsive"
                ...
                <li class="images-drop-down">
                    ...
                    <div class="Images animated fadeIn">
                        <div class="col-md-3">
                            ...
                            <img class="img-responsive" src="../image/cultura/secretaria-cultura .jpg" />
                        </div>
                        <div class="col-md-3">
                            <h4>Feira do Livro</h4>
                            <!--src="https://3.bp.blogspot.com/-hUt5FrdZHio/VcLb5dlwTBI/AAAAAAAAGCU/UUH5N1JkoQc/s1600/images1.jpg"  -->
                            <img class="img-responsive" src="../image/cultura/feira-livro.jpg" />
                        </div>
                        <!-- src="https://4.bp.blogspot.com/-A7U1uPlSq6Y/VcLb5kKHCkI/AAAAAAAAGCc/7WghyndTEuY/s1600/images2.jpg"   -->
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <img class="img-responsive" src="../image/cultura/desfile-da-patria-2019.jpg" />
                        </div>
                    </div>
                </li>
                <li>
